...
public class TicTacToeGame {
    ...
    private static char[] mBoard = {OPEN_SPOT, OPEN_SPOT, OPEN_SPOT, OPEN_SPOT, OPEN_SPOT, OPEN_SPOT, OPEN_SPOT, OPEN_SPOT, OPEN_SPOT};
    ...
    public void setBoardState(char[] copy){
        mBoard = copy.clone();
    }
